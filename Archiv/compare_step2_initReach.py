"""Compare Step 2's initReach_adaptive inputs and outputs between Python and MATLAB."""
import pickle
import scipy.io
import numpy as np
...
if python_step2 is None:
    print("ERROR: Could not find Python Step 2 Run 2 entry")
    exit(1)

if matlab_step2 is None:
    print("ERROR: Could not find MATLAB Step 2 Run 2 entry")
    exit(1)

print("=" * 80)
print("Step 2: initReach_adaptive Comparison")
print("=" * 80)
print()

# Get initReach_tracking
py_initReach = python_step2.get('initReach_tracking')
matlab_initReach = matlab_step2.initReach_tracking if hasattr(matlab_step2, 'initReach_tracking') else None
...
# Compare Rend.tp (output - becomes Rlintp)
print("--- Rend.tp (output - becomes Rlintp) ---")
...
# Compare Rend.ti (output - becomes Rlinti)
print("--- Rend.ti (output - becomes Rlinti) ---")
...
print("Summary:")
print("=" * 80)
print("The divergence in Rend.tp (Rlintp) originates from:")
if py_rstart_gen != matlab_rstart_gen:
