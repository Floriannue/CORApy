...
# Override type() to return the mock class name
def mock_type(obj):
...
class TestCompact:
    ...
    def test_compact_minimal_classes(self, monkeypatch):
    ...
    def test_compact_zonotope_defaults(self, monkeypatch):
        ...
        assert type(result).__name__ == "Zonotope"
    
    def test_compact_zonotope_methods(self, monkeypatch):
    ...
    def test_compact_polytope_methods(self, monkeypatch):
    ...
    def test_compact_conzonotope_methods(self, monkeypatch):
    ...
    def test_compact_polyzonotope_methods(self, monkeypatch):
    ...
    def test_compact_tolerance_validation(self, monkeypatch):
    ...
    def test_compact_aligned_method_tolerance_reset(self, monkeypatch):
    ...
    def test_compact_unknown_class(self, monkeypatch):
    ...
    def test_compact_not_implemented_error(self, monkeypatch):
    ...
    def test_compact_other_exception(self, monkeypatch):
