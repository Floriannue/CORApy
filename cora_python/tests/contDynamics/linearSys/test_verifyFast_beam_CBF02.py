...
class TestVerifyFastBeamCBF02:
    ...
    def test_verifyFast_beam_CBF02(self):
        ...
        # MATLAB: text = ['Beam,CBF02,',num2str(res),',',num2str(savedata.tComp)];
        text = f'Beam,CBF02,{res},{savedata.get("tComp", "N/A")}'
...
def test_verifyFast_beam_CBF02():
    ...
    result = test.test_verifyFast_beam_CBF02()
    
    print(f"test_verifyFast_beam_CBF02: result = {result}")
    return result
