"""
test_verifyFast_beam_CBC01 - beam benchmark from the
    2023 ARCH competition

Syntax:
    text = test_verifyFast_beam_CBC01()
...
class TestVerifyFastBeamCBC01:
    """Test class for beam CBC01 benchmark verification"""
    
    def test_verifyFast_beam_CBC01(self):
        """Test beam benchmark CBC01 from ARCH 2023 competition"""
        # Model Derivation --------------------------------------------------------
        ...
        # MATLAB: text = ['Beam,CBC01,',num2str(res),',',num2str(savedata.tComp)];
        text = f'Beam,CBC01,{res},{savedata.get("tComp", "N/A")}'
        
        return text


def test_verifyFast_beam_CBC01():
    """Test function for beam CBC01 benchmark verification.
    
    Runs all test methods to verify correct implementation.
    """
    test = TestVerifyFastBeamCBC01()
    result = test.test_verifyFast_beam_CBC01()
    
    print(f"test_verifyFast_beam_CBC01: result = {result}")
    return result


if __name__ == "__main__":
    test_verifyFast_beam_CBC01()
