...
def hessianTensor_laubLoomis(x, u):
    ...
    Hf[0] = scipy.sparse.csr_matrix((8, 8))

    Hf[1] = scipy.sparse.csr_matrix((8, 8))

    Hf[2] = scipy.sparse.csr_matrix((8, 8))
    Hf[2][1, 2] = -0.800000000000000
    Hf[2][2, 1] = -0.800000000000000

    Hf[3] = scipy.sparse.csr_matrix((8, 8))
    Hf[3][2, 3] = -1.30000000000000
    Hf[3][3, 2] = -1.30000000000000

    Hf[4] = scipy.sparse.csr_matrix((8, 8))
    Hf[4][3, 4] = -1.00000000000000
    Hf[4][4, 3] = -1.00000000000000

    Hf[5] = scipy.sparse.csr_matrix((8, 8))

    Hf[6] = scipy.sparse.csr_matrix((8, 8))
