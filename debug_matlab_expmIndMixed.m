% debug_matlab_expmIndMixed.m
% MATLAB debug script to generate I/O pairs for expmIndMixed
% 
% This script tests the expmIndMixed function and outputs all intermediate
